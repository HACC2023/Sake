        ...
        <Modal.Body>
          {selectedCustomer && (
            <div>
              ...
              <p>Small Containers: {selectedCustomer.smallContainers}</p>{" "}
              {/* ideally these values are queried from our database? */}
          ...
          {filteredCustomers.map(customer => (
            <tr key={customer.id}>
              ...
              <td>
                <Button
                  variant="primary"
                  onClick={() => handleSeeContainers(customer.id)}
                >
                  See Containers
                </Button>{" "}
                <Button
                  variant="danger"
                  onClick={() => handleRemoveContainers(customer.id)}
                >
                  Remove Containers
                </Button>
              </td>
